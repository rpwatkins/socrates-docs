...
[source,console]
----
wget https://github.com/rpwatkins/socrates/releases/download/v0.0.1/socrates_0.1.0_linux_amd64.tar.gz
tar -xvzf socrates_0.1.0_linux_amd64.tar.gz
...
[source,console]
----
curl -OL https://github.com/rpwatkins/rpwatkins/releases/download/v0.0.1/socrates_0.1.0_darwin_amd64.tar.gz
tar -xvzf socrates_0.1.0_darwin_amd64.tar.gz
sudo mv socrates /usr/local/bin/socrates
